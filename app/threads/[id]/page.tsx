...
const ThreadDetail = () => {
  ...
  const toggleCheck = (commentId: string) => {
                    ...
                    {thread?.comments.map((comment) => (
                      <div key={comment.id} className="mb-4">
                        <p className="bg-slate-200 rounded p-3 text-teal-900 font-semibold">
                          {comment.content}
                          {checkAnswer === comment.id && <CheckIcon className="text-green-600 ml-2 float-right" />}
                        </p>
                        <p className="text-white text-sm flex p-1 justify-between ">
                          ...
                          {thread.category === 'QNA' && (
                            ...
                            >
                              ...
                              <p className="bg-gray-950">{checkAnswer === comment.id ? 'Remove answer' : 'Mark as answer'}</p>
                            </button>
                          )}
                        </p>
